...
Modifications:
- Adapted prompts for different platform variants
"""
...
class Prompts:
    ...
    **Requirements:**  
    ...
    prompt_idea_check_no_reference = """You are an ambitious scientist who is looking to publish a paper that will contribute significantly to the field. 
    Your team has generated several ideas, and you want to evaluate their novelty. 
    Please adopt a rigorous standard for novelty, ensuring that select the idea that is the most innovative and distinct from the existing ideas. 
    Remember, the goal is to choose an idea that the most unique and original.
    """

    prompt_idea_check_response_no_reference = """Your team generated these ideas: {existing_idea}.
    Respond in the following format: 
    THOUGHT: 
    <THOUGHT>
    RESPONSE: 
