...
This file is a new entry script for running experiments with the no_real platform variant.
"""

from sci_platform_no_real import Platform
from utils.scientist_utils import read_txt_files_as_dict
import os
import argparse
import asyncio
from configs import deploy_config_real
def parse_arguments():
    ...
    parser.add_argument(
        "--model_name",
        type=str,
        default=deploy_config_real.model_name,
        help="employed base model",
    )
    parser.add_argument(
        "--leader_mode",
        type=str,
        default=deploy_config_real.leader_mode,
        help="who is the leader",
    )
    parser.add_argument(
        "--checkpoint",
        type=bool,
        default=deploy_config_real.checkpoint,
    ...
    parser.add_argument(
        "--test_time",
        type=str,
        default=deploy_config_real.test_time,
        help='save new file',
    )
    # load_time
    parser.add_argument(
        "--load_time",
        type=str,
        default=deploy_config_real.load_time,
        help="load old file",
    )
    # how many scientists
    parser.add_argument(
        ...
        type=int,
        # default=2000,
        default=deploy_config_real.agent_num,
    ...
    parser.add_argument(
        ...
        type=list,
        # default=2000,
        default=deploy_config_real.ips,
    ...
    parser.add_argument(
        ...
        default=deploy_config_real.port,
    ...
    parser.add_argument(
        ...
        type=int,
        # default = 1
        default=deploy_config_real.runs,
    ...
    parser.add_argument(
        ...
        type=int,
        # default = 4
        default=deploy_config_real.team_limit,
    ...
    parser.add_argument(
        ...
        type=int,
        # default = 1
        default=deploy_config_real.max_discuss_iteration,
    ...
    parser.add_argument(
        ...
        type=int,
        # default = 6
        default=deploy_config_real.max_team_member,
    ...
    parser.add_argument(
        ...
        type=int,
        # default = 50
        default=deploy_config_real.epochs,
        help="Epochs.",
    )
